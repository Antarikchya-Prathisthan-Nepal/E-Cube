...
import SupportOverlay from './SupportOverlay.vue'
import OtherProjects from './components/OtherProjects.vue'
import expboards from './components/expboards.vue'
import "./style.css";
...
export default {
  ...
  Layout: () => {
    return h(DefaultTheme.Layout, null, {
      'nav-bar-content-after': () => h(SupportOverlay)
  ...
  enhanceApp({ app, router, siteData }) {
    ...
    app.component('expboards', expboards)
  },
